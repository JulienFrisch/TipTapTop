...
class GameViewController: UIViewController, ViewControllerDelegate {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        switch level {
            ...
            case "MotionMulti_Easy": scene = MotionMulti_Easy(fileNamed: "GameScene")
            ...
            case "Moving_Easy": scene = Moving_Easy(fileNamed: "GameScene")
            case "Moving_Hard": scene = Moving_Hard(fileNamed: "GameScene")
